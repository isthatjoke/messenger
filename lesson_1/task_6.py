...
with open('test_file_2.txt', 'rb') as file:
    file_data = file.read()
    determine_enc = chardet.detect(file_data)
    file_data_encoding = determine_enc['encoding']

if not file_data_encoding == 'utf-8':
    file_data = file_data.decode(file_data_encoding).encode('utf-8').decode('utf-8')
    with open('test_file_2.txt', 'w', encoding='utf-8') as file:
        file.write(file_data)

with open('test_file_2.txt', encoding='utf-8') as file:
    print(file.read())
