import os
from logging import Formatter, getLogger, DEBUG, FileHandler, StreamHandler, WARNING
from additionals.settings import LOGGING_LEVEL, ENCODING

PATH = os.path.dirname(os.path.abspath(__file__))
PATH = os.path.join(PATH, '..', 'log_files/', 'app.client_.log')

# logger app init
logger = getLogger('app.client_')
