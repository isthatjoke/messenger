...
try:
    while True:
        ...
        if cmd == 'start':
            ...
            # process_list.append(subprocess.Popen('python3 client_oop.py -n first', creationflags=subprocess.CREATE_NEW_CONSOLE)) #win
            # process_list.append(subprocess.Popen('python3 client_oop.py -n second', creationflags=subprocess.CREATE_NEW_CONSOLE)) #win
            # process_list.append(subprocess.Popen('python3 client_oop.py -n third', creationflags=subprocess.CREATE_NEW_CONSOLE)) #win
